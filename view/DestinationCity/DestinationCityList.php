...
<?php
  ...
  echo PopupCloseWidowHref("洋宏後台海運網","確認是否將此貨櫃目的地刪除?","確認","取消","",false,"destination_city_del");
  echo PopupCloseWidowHref("洋宏後台海運網","確認是否將此貨櫃目的地還原至未刪除?","確認","取消","",false,"destination_city_reply");
